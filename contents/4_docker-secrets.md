...
- If the image is reliant on external files for configuration, this causes the image to couple with the configuration and breaks the [reusability](https://earthly.dev/blog/achieving-repeatability) principle.
...
- Secrets access follows the [principle of least privilege](https://www.docker.comhttps://earthly.dev/blog/least-privilege-container-orchestration/).
...
![Docker version](./images/4/efa4xhP.png)

- Docker is running on Swarm mode. Run `docker info` to confirm:

![Docker Swarm](./images/4/V5HcgCK.png)
...
<div class="wide">
![Docker Swarm init](./images/4/c1ildpG.png)
</div>
