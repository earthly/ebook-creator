...
<div class="wide">
![`docker volume ls`](./images/2/jgrmG9u.png)
</div>
...
<div class="wide">
![`docker volume inspect`](./images/2/tFMRmjM.png)
</div>
...
<div class="wide">
![Container content](./images/2/ge5QZEv.png)
</div>
...
<div class="wide">
![Copying files](./images/2/AkCRBoI.png)
</div>
...
- Always use [environment variables](https://earthly.dev/blog/understanding-bash) for the host path or volume name in a production environment.
